...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Self-Play
        self.num_workers = 2  # Set to higher no better performance Number of simultaneous threads/workers self-playing to feed the replay buffer
        self.selfplay_on_gpu = False # set to true
